...
- **Магистратура**  
  ...
  *2023–2025 | GPA: 4.95/5.0*  
  ...
  🔹 Компьютерное зрение (CV), машинное обучение (ML), обработка поляризационных изображений  
...
- **Бакалавриат**  
  ...
  *2019–2023 | GPA: 4.83/5.0*  
  ...
  🔹 Прикладная оптика, спектроскопия, автоматизация измерений (Python/Matlab), методика по программе OriginLAB  
